...
class NSVFModel(NeRFModel):
    ...
    def raymarching(self, ray_start, ray_dir, intersection_outputs, encoder_states, fine=False):
        ...
        print(all_results['colors'].shape,samples['sampled_point_depth'].shape,samples['sampled_point_voxel_idx'].shape,samples['sampled_point_xyz'].shape,samples['sampled_point_ray_direction'].shape)
